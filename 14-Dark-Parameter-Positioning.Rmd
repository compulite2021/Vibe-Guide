...
- [14.1. Look Ahead (Move in Dark)](#LookAhead-14.1.)
- [14.2. Look Ahead Cue (Mark)](#LookAheadCue-14.2.)
- [14.3. Force Black](#ForceBlack-14.3.)


## Look Ahead (Move in Dark) {#LookAhead-14.1.}
...
**Set individual Look Ahead Time -** Speed at which fixtures move in dark.
...
## Look Ahead Cue (Mark) {#LookAheadCue-14.2.}


 <span style="color:Blue">Unimplemented</span>

-   <span style="color:Gray">Look Ahead: (sometimes referred to a Mark Cue) </span>

    -  <span style="color:Gray">Unlike having Look Ahead automatically preposition all dark parameters for all cues in a Qlist, a cue tagged in Cue Store **Options** as {Look Ahead} will preposition dark parameters for just the tagged cue.</span>



## Force Black {#ForceBlack-14.3.}
