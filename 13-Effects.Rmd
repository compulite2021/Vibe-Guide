...
-   Effect Libraries are stored similar to normal Libraries [Store and Modify Bank Libraries](#StoreandModifyBankLibraries-12.2.).
...
2.  Select the **parameter/parameters** to be in the Effect [9.4.2. What are Parameters](#What-are-Parameters-9.3.2.)
...
8.  Set Swing (In Base) as needed [13.1. Effects Basics](#EffectBasics-13.1.)
