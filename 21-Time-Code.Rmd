...
-   [21.1. Timecode and Timeline basics](#21.1.TimecodeandTimelinebasics)
    
-   [21.2. Create a Timeline View](#21.2.CreateaTimelineView)
    
-   [21.3. Configuring Timecode](#21.3.ConfiguringTimecode)
    
-   [21.4. Recording Timeline Tracks](#21.4.RecordingTimelineTracks)
    
-   [21.5. Executing and Editing Events](#21.5.ExecutingandEditingEvents)
    
-   [21.6. Markers](#21.6.Markers)

-   [21.7. Time Format](#21.7.TimeFormat)

## Timecode and Timeline basics {#21.1.TimecodeandTimelinebasics}
...
## Create a Timeline View {#21.2.CreateaTimelineView}
...
## Configuring Timecode {#21.3.ConfiguringTimecode}
...
## Recording Timeline Tracks {#21.4.RecordingTimelineTracks}
...
## Executing and Editing Events {#21.5.ExecutingandEditingEvents}
