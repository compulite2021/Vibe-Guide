...
-  [5.1.   Fixture Sets](#Fixture-Sets-5.1)
-  [5.2.   Import Devices](#Import-Devices-5.2)
-  [5.3.   Advanced Search](#Advanced-Search-5.3)
-  [5.4.   Create and Patch imported fixtures](#Create-and-Patch-imported-fixtures-5.4)
-  [5.5.   Configuring Physical DMX I/0](#Configuring-Physical-DMX-1-0-5.5)
-  [5.6.   Patching Inputs](#Patching-Inputs-5.6)
-  [5.7.   Parking Addresses and Fixtures](#Parking-Addresses-and-Fixtures-5.7)
-  [5.8.   Clone Fixtures](#Clone-Fixtures-5.8)
-  [5.9.   Device Replacement](#Device-Replacement-5.9)
-  [5.10.  DMX Output & Input](#DMX-Output-and-Input-5.10)

## Fixture Sets {#Fixture-Sets-5.1}
...
## Import Devices {#Import-Devices-5.2}
...
## Advanced Search {#Advanced-Search-5.3}
...
5. Review the DMX implementation and select the desired mode. 
...
## Create and Patch imported fixtures {#Create-and-Patch-imported-fixtures-5.4}


1. Import the desired device. (See [5.2. Import Devices](#Import-Devices-5.2)).
...
1. Create fixtures - (See: [5.4. Create and patch imported fixtures](#Create-and-Patch-imported-fixtures-5.4)).
...
See: 
[19. XYZ Fixture Calibration](#XYZ-Fixture-Calibration-19.0.) 
...
## Configuring Physical DMX I/0 {#Configuring-Physical-DMX-1-0-5.5}
...
1. Open the {DMX SETTINGS} from Vibe Menu > Settings or tap the DMX Settings button - The DMX Properties pop-up will open.
...
## Patching Inputs {#Patching-Inputs-5.6}
...
> **E.g**. [ADDRESS] [1] {INPUT PATCH TO} [ADDRESS] [1] [STORE] - When DMX 1 is received from an external source like a console, DMX 1 will directly output to the Vibes DMX output. No values will be shown in the live display as no actual parameters are involved.
...
## Parking Addresses and Fixtures {#Parking-Addresses-and-Fixtures-5.7}
...
See: [17.2. Patch Exam](#PatchExam-17.2.)
...
## Clone Fixtures {#Clone-Fixtures-5.8}
...
## Device Replacement {#Device-Replacement-5.9}
...
## DMX Output & Input {#DMX-Output-and-Input-5.10}
