...
1. Import the desired device. (See [6.2. Import Devices](https://vibemanual.compulite.com/patch.html#import-devices)).
...
1. Create fixtures - (See: [6.4. Create and patch imported fixtures](https://vibemanual.compulite.com/patch.html#create-and-patch-imported-fixtures)).
...
(See: [18.2. Patch Exam](https://vibemanual.compulite.com/exam-show-data.html#patch-exam))
