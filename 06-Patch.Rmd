...
-  [6.1.   Fixture Sets](#6.1-Fixture-Sets)
-  [6.2.   Import Devices](#6.2-Import-Devices)
-  [6.3.   Advanced Search](#6.3-Advanced-Search)
-  [6.4.   Create and Patch imported fixtures](#6.4-Create-and-Patch-imported-fixtures)
-  [6.5.   Configuring Physical DMX 1/0](#6.5-Configuring-Physical-DMX-1/0)
-  [6.6.   Patching Inputs](#6.6-Patching-Inputs)
-  [6.7.   Parking Addresses and Fixtures](#6.7-Parking-Addresses-and-Fixtures)


## Fixture Sets {#6.1-Fixture-Sets}
...
## Import Devices {#6.2-Import-Devices}
...
## Advanced Search {#6.3-Advanced-Search}
...
## Create and Patch imported fixtures {#6.4-Create-and-Patch-imported-fixtures}
...
## Configuring Physical DMX 1/0 {#6.5-Configuring-Physical-DMX-1/0}
...
## Patching Inputs {#6.6-Patching-Inputs}
...
## Parking Addresses and Fixtures {#6.7-Parking-Addresses-and-Fixtures}
