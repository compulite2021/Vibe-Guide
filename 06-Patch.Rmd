...
4.  A new list and search window will open. If the exact device name is known, type it in the search window, if not flick or drag to browse the list until the desired device is found.
    ...
    ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FAUMZKpfdB34jywodQrO7%2Fimage.png?alt=media&token=431ecdec-063a-4a18-bf87-ae81bb29f889)
    
5. The < key may be pressed at any time to return to the Imported Devices list.
    
    ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2F4tjZs5njqhMzp7bbKLsG%2Fimage.png?alt=media&token=4af0db3d-b44c-4863-aa08-d32d817decbe)
    
6. .
    
    ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2F0TwiXXhqaNIzq1ts1LHL%2Fimage.png?alt=media&token=e89933c0-2019-4fda-8875-3dfaed6f85fc)
...
![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FAhrPAXebL2lasJ1WM2k5%2Fimage.png?alt=media&token=de407624-9c32-4abc-8abf-1dce806ca92f)

5. The DMX Modes pop-up will open. 
6. Review the DMX implementation and select the desired mode. 
7. Tap ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FBBvbBF5WD2r2B0yIuQHd%2Fimage.png?alt=media&token=635e83af-37a1-4bad-b8be-8d516b1c4246) or press [ENTER] to close the pop-up and add the fixture to the Imported Devices list.
...
![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2Ff9eVMyaXgozk0Gdx4lvu%2Fimage.png?alt=media&token=b239533b-b082-44cb-b4d4-b86b0d6eb538)
...
11. To complete **CREATE and PATCH** tap the **{APPLY & CONTINUE}** key in the bottom **right corner of the pop-up**, Press **[ENTER]**, or tap ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FBBvbBF5WD2r2B0yIuQHd%2Fimage.png?alt=media&token=635e83af-37a1-4bad-b8be-8d516b1c4246) to close the pop-up and return to the patch workspace.
...
◾ [FIXTURE] [#] [ADDRESS] [#].[#] (👉 By default, the first available DMX address of the selected Universe will be shown in the **ADDRESS** field. If the default start address is not appropriate, type or scroll the list to the desired start address and tap it.Universe.Address), [STORE]. **Or** ◾ [ADDRESS] [#].[#] +/ - ➡️ [#].[#] [FIXTURE] [#] [STORE].
...
![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FOUjRNeP13oCfbjf2DHvf%2Fimage.png?alt=media&token=7501c3cb-0572-4bcd-989c-9ca5cac5e63a)
...
> All types of fixtures may be multi-patched but caution should be used when 
> multi-patching multi-parameter fixtures.
...
> Once patched fixtures can be modified using keypad syntax or using the
> two Patch Toolbars in the Patch Workspace.

**Toolbar with no fixture selection:**

![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FqKMW5KV6R4utuJVcSVsR%2Fimage.png?alt=media&token=a7f67f72-ce3d-4d33-bf3c-c0bc08b359cc)

◾ {CLEAR PATCH} - Opens up Clear Patch pop-up. ◾ {RENUMBER} - Opens up RENUMBER: FIXTURE pop-up. ◾ {ADD FIXTURE} - Opens the Create And Patch pop-up. ◾ {DELETE FIXTURE} - Opens up Delete Fixtures pop-up.

**Toolbar with fixture selection:**

![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FotGVSrjFRfLjFfyVTGIP%2Fimage.png?alt=media&token=68199556-cfb9-4e09-824b-6a2ce4950f75)

◾ [FIXTURE] [#] {PATCH} - Opens up Patch Fixture pop-up. ◾ [FIXTURE] [#] {RENUMBER} - Opens up RENUMBER: FIXTURE pop-up with fixture already selected. ◾ [FIXTURE] [#] {FIXTURE CALIBRATION} - Opens up Fixture Calibration pop-up with the fixture selected. See: 20. XYZ Fixture Calibration ◾ [FIXTURE] [#] {CLEAR PATCH} - Opens the Clear Patch confirmation popup ◾ [FIXTURE] [#] {DELETE FIXTURE} - Opens the Delete Fixture confirmation pop-up

**Modify the patch using keypad syntax:** ◾ [FIXTURE] [#] {CLEAR PATCH} - From the Editor toolbar. ◾ [FIXTURE] [#] [DELETE] - Only works in the Patch Workspace.
...
![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2Fj4n2nAFW40634aOq7a0D%2Fimage.png?alt=media&token=1f17e796-5f31-44f8-a684-5437018a3fc8)
...
5. Press ENTER, or tap   ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FBBvbBF5WD2r2B0yIuQHd%2Fimage.png?alt=media&token=635e83af-37a1-4bad-b8be-8d516b1c4246) to close the pop-up and complete the patch.
    

![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FqScO17uMOAvMRfx3MPAQ%2Fimage.png?alt=media&token=659d250e-b572-4978-825b-fceebb565c77)
...
3. Tap ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FBBvbBF5WD2r2B0yIuQHd%2Fimage.png?alt=media&token=635e83af-37a1-4bad-b8be-8d516b1c4246)  or press [ENTER] to close the pop-up and park the address.
...
3. Tap ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FBBvbBF5WD2r2B0yIuQHd%2Fimage.png?alt=media&token=635e83af-37a1-4bad-b8be-8d516b1c4246) or press [ENTER] to close the pop-up and unpark the address.
