...
-  [8.1. Operational Philosophy](#8.1.OperationalPhilosophy)
-  [8.2. Command Syntax](#8.2.CommandSyntax)
-  [8.3. Command Line](#8.3.CommandLine)

## Operational Philosophy {#8.1.OperationalPhilosophy}
...
## Command Syntax {#8.2.CommandSyntax}
