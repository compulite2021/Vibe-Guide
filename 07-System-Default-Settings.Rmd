...
-   Tracking On: ◾ Values track forward. The stage look is made up of a combination of hard and tracked values.
    
-   Non-Tracking: ◾ Only hard values are recorded and zero dimmer values is treated as a hard zero.
...
-   Default timing when the GOTO command is used. GOTO time can be overridden using command [GOTO] [CUE] [#] [TIME] [Value]Press ![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FBBvbBF5WD2r2B0yIuQHd%2Fimage.png?alt=media&token=635e83af-37a1-4bad-b8be-8d516b1c4246)  or [ENTER]. 
...
-   **Virtual Wheel:** ◾ Wheel at Default - System Default Release time is referenced. ◾ Using virtual wheel - Rotate the wheel to set a Qlist specific time that a controller references to fade to off. ◾ Using keypad - Tap the inside of the virtual wheel until it turns red. Set a release value from the keypad.
    
-   **Button under wheel:** Toggles between Milliseconds, Seconds, Minutes, Hours.
    

**Defaults** - Qlist Properties: ◾ **Restore default** - Resets Qlist properties to their last stored configuration.
...
-   **Properties:** ◾ [10.12.3. Tracking Options](/s/3kS90tLsADGm1ocbe7q9/10.-programming-cues-and-scenes/10.-programming-cues-and-scenes/10.12.3.-tracking-options)
