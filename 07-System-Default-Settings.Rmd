...
-  [7.1. Editing](#7.1.Editing)
-  [7.2. Timing](#7.2.Timing)
-  [7.3. Network](#7.3.Network)
-  [7.4. Hardware](#7.4.Hardware)
-  [7.5. Defaults](#7.5.Defaults)
-  [7.6. System](#7.6.System)
...
**Delete Selected / Clear Device IP History**
...
-  [7.5.1. Controller Settings](https://vibemanual.compulite.com/system-default-settings.html#controller-settings)
-  [7.5.2. Controller Actions](https://vibemanual.compulite.com/system-default-settings.html#controller-actions)
-  [7.5.3. Qlist Properties](https://vibemanual.compulite.com/system-default-settings.html#qlist-properties)
-  [7.5.4. Chaser Properties](https://vibemanual.compulite.com/system-default-settings.html#chaser-properties)
-  [7.5.5. Cue Settings](https://vibemanual.compulite.com/system-default-settings.html#cue-settings)
-  [7.5.6. Cue Store Options](https://vibemanual.compulite.com/system-default-settings.html#cue-store-options)
-  [7.5.7. Scene Settings](https://vibemanual.compulite.com/system-default-settings.html#scene-settings)
-  [7.5.8. Scene Store Options](https://vibemanual.compulite.com/system-default-settings.html#scene-store-options)
-  [7.5.9. Bank Library Options](https://vibemanual.compulite.com/system-default-settings.html#bank-library-options)
-  [7.5.10. Snap Settings](https://vibemanual.compulite.com/system-default-settings.html#snap-settings)
-  [7.5.11. Effects](https://vibemanual.compulite.com/system-default-settings.html#effects)
...
-   The Default button assignments when a Qlist or Scene is assigned to a controller ( **See:** [14.5. Configuring Controllers](https://vibemanual.compulite.com/playback-controllers.html#configuring-controllers))
...
-   **Build** - <span style="color:Gray">Cues are added on to each other until the end of the Qlist and then the build is repeated. (Normal tracking behaviour).</span>
...
**See**: [10.7. Cue Store Options](https://vibemanual.compulite.com/programming-cues-and-scenes.html#cue-store-options-1)
...
**Similar to Cue Store Options. See:** [10.7. Cue Store Options](https://vibemanual.compulite.com/programming-cues-and-scenes.html#cue-store-options-1)
...
See: [17. Snaps](https://vibemanual.compulite.com/snaps-snapshots.html)
