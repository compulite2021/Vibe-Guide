...
-   <span style="color:MediumSpringGreen">{Advance To Cue After Store} = Off</span>
...
-   {Restore Popup Positions} - <span style="color:MediumSpringGreen">Currently redundant.</span>
...
-   OFF <span style="color:MediumSpringGreen">(NOT QONLY)</span> - Tracking is not calculated and dimmer at zero is treated as a hard zero (Compulite Mode).
