...
- [11.1. What are Libraries](#WhatareLibraries-11.1.)
- [11.2. Store and Modify Bank Libraries](#StoreandModifyBankLibraries-11.2.)
- [11.3. Object Libraries](#ObjectLibraries-11.3.)
- [11.4. Auto Generate](#Auto-Generate-11.4.)

## What are Libraries {#WhatareLibraries-11.1.}
...
2.  Object Libraries - Pools of system object types.
...
## Store and Modify Bank Libraries {#StoreandModifyBankLibraries-11.2.}
...
**Libraries can be assigned one of six behaviors:**
...
6.   **Device and pattern** – Values will be applied to fixtures of the same device type and keep the pattern of values. 

Library Bank SKs have default filters and behaviors based on the way they are commonly used.

**Store directly to a Bank SK Library:**
...
3. Press [STORE] - The Library {Store Options} tab will appear on top right corner of SKs.
4. Use the Library {Store Options} pop-up at the bottom on the Smart Screen to make option changes.
5. Tap destination Library SK.
...
<p align="center">
  <img width="" height="" src="https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FKeFZwX4YqebXrAJ6H335%2F12.2.png?alt=media&token=97b093e2-f4c0-4b69-99f0-89e735f66480"> 
</p>

<p align=center> Update pop-up</p>
...
<p align="center">
  <img width="" height="" src="https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FViZ86urYtuJEwYHs9Pz9%2Fimage.png?alt=media&token=5a876ccb-256d-40c6-afc6-8a4fe1bfd425"> 
</p>

<p align=center> Object Exists pop-up</p>


<p align="center">
  <img width="" height="" src="https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FTFtIlY02FdG9tk8XcTxR%2F12.2.1.png?alt=media&token=52aca567-ad5b-42f0-9368-8dff44a526ea"> 
</p>

<p align=center> Library Settings pop-up</p>
...
## Object Libraries {#ObjectLibraries-11.3.}
...
-   [15.1. Creating Macros](#CreatingMacros-15.1.)
    
-   [16.1. Storing Snaps](#StoringSnaps-16.1.)


## Auto Generate {#Auto-Generate-11.4.}

The option to Auto Generate Groups and Libraries is on the Editor Toolbar in Patch pages. It permits a smart and fast creation of the most common libraries.

The user can configure the numbering and the number of libraries to be created, by selecting the generate options in the popup menu.

![](https://files.gitbook.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3kS90tLsADGm1ocbe7q9%2Fuploads%2FgpYYgkcJxyiMp3Rq0xtt%2Fimage.png?alt=media&token=4109d5d6-e5af-4da3-a65c-b5f9e59b7360)



It is possible to merge or to overwrite the auto generated libraries with the already existing ones.

Libraries can be named using system names or library numbers, and customized for example using the device's name.

Libraries can be numbered starting from a desired number or appended for the first available position.

Libraries of different fixture types can be spaced with the desired interleave.

Auto generated libraries are created when pressing the GENERATE button on the down right corner. It is possible to check the preferred options on each bank page and then generate them in a single click, as well as to generate them step by step for each device or for each bank.