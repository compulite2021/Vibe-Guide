...
create_image_tag <- function(folder, name, url, height = NULL) {
  # Construct the img tag as a string
  img_tag <- paste0('<p align=center> <img src="Images/', folder, '/', name, '.webp" onerror="this.onerror=null; this.src=\'', url, '\';" alt="', name, '"')
...
img_tag <- paste0('<img src="', localPath, 
